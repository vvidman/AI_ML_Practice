...
'''
To evaluate how well the logistic regression model performed, we’ll use several metrics, 
including accuracy, a confusion matrix, and a classification report (which includes precision, recall, and F1 score):
'''
